...
def _demo_materials() -> list[Material]:
    return [
        Material(id=1, manufacturer="Blank", brand="Blank", material_name="Грунт-Эмаль Blank Universal", material_type=MaterialType.PRIMER_ENAMEL, binder_type=BinderType.EPOXY, density=1.4, solids_percent=73.0, price_per_kg=552.0, recommended_dft_min=100, recommended_dft_max=200, packaging_kg=20.0),
        Material(id=2, manufacturer="Blank", brand="Blank", material_name="Эмаль Blank Finish", material_type=MaterialType.FINISH, binder_type=BinderType.POLYURETHANE, density=1.3, solids_percent=58.0, price_per_kg=892.0, recommended_dft_min=60, recommended_dft_max=100, packaging_kg=20.0),
        Material(id=3, manufacturer="Blank", brand="Blank", material_name="Цинконаполненный грунт", material_type=MaterialType.ZINC_RICH, binder_type=BinderType.EPOXY, density=2.5, solids_percent=65.0, price_per_kg=1200.0, recommended_dft_min=40, recommended_dft_max=80, packaging_kg=25.0),
