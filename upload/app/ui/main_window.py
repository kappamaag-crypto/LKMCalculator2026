...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        self.tabs.addTab(self.calc_view,"Расчёт");self.tabs.addTab(self.rec_view,"Рекомендации");self.tabs.addTab(self.cmp_view,"Сравнение");self.tabs.addTab(self.two_component_view,"2К-информация");self.tabs.addTab(self.materials_view,"База материалов");self.tabs.addTab(self.systems_view,"Системы");self.tabs.addTab(self.catalog_review_view,"Каталог систем");self.tabs.addTab(self.history_view,"История");self.tabs.addTab(self.book_search_view,"Инженерная БД");self.tabs.addTab(self.inspection_view,"Инспекция");self.tabs.addTab(self.settings_view,"Настройки")
