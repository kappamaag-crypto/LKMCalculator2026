...
class ExcelExporter:
    ...
    def _sheet_layers(self,ws:Worksheet,result:SystemCalculationResult)->None:
        ...
        headers=["№","Материал","Связующее","DFT, мкм","WFT, мкм","Потери, %","Разб., %","Укрыв. теор., м²/л","Укрыв. практ., м²/л","Расход теор., кг/м²","Расход практ., кг/м²","Расход практ., л/м²","Стоимость материала, руб/м²","Разбавитель, руб/м²","Итого, руб/м²","Расход на объект, кг","Стоимость на объект, руб"]
