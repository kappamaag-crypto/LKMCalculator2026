...
class TestSystemCalculator:
    ...
    def test_direct_area_is_sole_scaling_source(self):
        ...
        assert result.layers[0].total_consumption_l==pytest.approx(result.layers[0].practical_consumption_l*200)
    ...
    def test_missing_material_price_does_not_block_system_consumption(self):
        ...
        assert result.total_practical_consumption_kg>0
        assert result.total_practical_consumption_l>0
