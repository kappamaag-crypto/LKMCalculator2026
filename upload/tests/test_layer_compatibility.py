...
def test_engine_checks_every_adjacent_transition_in_a_four_layer_system():
    ...
    assert report.transitions[0].status is CompatibilityStatus.ALLOWED
    assert report.transitions[1].status is CompatibilityStatus.ALLOWED
    assert report.transitions[2].status is CompatibilityStatus.ALLOWED
    assert report.status is CompatibilityStatus.ALLOWED
