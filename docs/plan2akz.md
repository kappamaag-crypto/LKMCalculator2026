...
| 27 | НЕ ВЫПОЛНЕНО | Material Data Quality / полнота карточек — P1. |
| 28 | НЕ ВЫПОЛНЕНО | Loss Profile / расход и потери — P1. |
| 29 | НЕ ВЫПОЛНЕНО | System Templates — P2. |
| 30 | НЕ ВЫПОЛНЕНО | Engineering Decision Log — P2. |
| 31 | НЕ ВЫПОЛНЕНО | Calculation Scenarios / инженерные сценарии — P2. |
